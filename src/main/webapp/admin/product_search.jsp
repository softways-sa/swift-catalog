...
String urlSearch = response.encodeURL("product_search.jsp"),
       urlQuerySearch = "product_search.jsp?prdId=" + SwissKnife.hexEscape(prdId)
        ...
        <td valign="top">
            ...
            <tr>
			    ...
			    <tr>
                                ...
                                <td class="searchFrmTD" align="left">Κατηγορία:</td>
                                <td class="searchFrmTD" align="left">Προσφορές:</td>
                                <td class="searchFrmTD" align="left"></td>
                                <td class="searchFrmTD" align="left"><img src="images/dot_blank.gif" width="20" height="1" /></td>				
                                <td class="searchFrmTD" align="left"></td>
                                <td class="searchFrmTD" align="left"></td>				
			   </tr>
                            <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="10" class="resultsTBL">
            ...
            %>
                <tr class="resultsDataTR" onmouseover="this.className='resultsDataTROver'" onmouseout="this.className='resultsDataTR'">
                    <td class="resultsDataTD" onmouseover="this.className='resultsDataTDOver'" onmouseout="this.className='resultsDataTD'"><a href="<%= response.encodeURL("product_update.jsp?action1=EDIT&prdId=" + app_searchprd.getHexColumn("prdId"))%>" class="resultsLink"><%= app_searchprd.getColumn("prdId")%></a></td>
                    ...
                    <td align="left" class="resultsDataTD" onmouseover="this.className='resultsDataTDOver'" onmouseout="this.className='resultsDataTD'"><%= SwissKnife.formatNumber(retailPrice.getUnitGrossCurr1().setScale(curr1DisplayScale, BigDecimal.ROUND_HALF_UP),localeLanguage,localeCountry,minCurr1DispFractionDigits,curr1DisplayScale) %> &euro;</td>
