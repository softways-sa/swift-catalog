...
<%@ page import="java.sql.Timestamp
    ,gr.softways.dev.util.*
    ,gr.softways.dev.util.SwissKnife
    ,gr.softways.dev.swift.cmcategory.CMCategoryType
...
CMRowAttribs cmrowAttribs = null;
...
String CMRTitle = "", CMRTitleLG = "", 
       ...
       CMRHeadHTML = "", CMRBodyHTML = "", CMRAttribs = "";
...
if (action.equals("EDIT")) {
    ...
    if (found < 0) {
        ...
        CMRAttribs = sw_cmrow.getColumn("CMRAttribs");
        cmrowAttribs = new CMRowAttribs(CMRAttribs);
    }
}
else {
        ...
        <td valign="top">
            ...
            <tr>
                ...
                <td class="inputFrmFieldTD">
                    ...
                    <tr>
                        <td valign="top"><img src="images/flag.gif" ></td>
                        <td class="inputFrmFieldTD"><textarea name="CMRText" id="CMRText" style="width: 80%; height: 400px;" class="inputFrmField" onfocus="this.className='inputFrmFieldFocus'" onblur="this.className='inputFrmField'"><%= CMRText %></textarea></td>
                    </tr>
                    <tr>
                        <td valign="top"><img src="images/flagLG.gif"></td>
                        <td class="inputFrmFieldTD"><textarea name="CMRTextLG" id="CMRTextLG" style="width: 80%; height: 400px;" class="inputFrmField" onfocus="this.className='inputFrmFieldFocus'" onblur="this.className='inputFrmField'"><%= CMRTextLG %></textarea></td>
                    </tr>
                    </table>
                </td>
            </tr>
            <tr>
              <td class="inputFrmLabelTD">Έχει δεξί πλαίσιο</td>
              <td class="inputFrmFieldTD">
                Όχι <input style="float: none;" type="radio" name="CMRAttribs_right_sidebar" value="0" <%if ("".equals(cmrowAttribs.getValue("right_sidebar")) || "0".equals(cmrowAttribs.getValue("right_sidebar")) || cmrowAttribs.getValue("right_sidebar") == null) out.print("checked=\"checked\"");%> />
                &nbsp;&nbsp;&nbsp;&nbsp;
                Ναι <input style="float: none;" type="radio" name="CMRAttribs_right_sidebar" value="1" <%if ("1".equals(cmrowAttribs.getValue("right_sidebar"))) out.print("checked=\"checked\"");%> />
              </td>
            </tr>
            <tr>
              <td class="inputFrmLabelTD">Καταλαμβάνει όλο το πλάτος της οθόνη</td>
              <td class="inputFrmFieldTD">
                Όχι <input style="float: none;" type="radio" name="CMRAttribs_full_screen_width" value="0" <%if ("".equals(cmrowAttribs.getValue("full_screen_width")) || "0".equals(cmrowAttribs.getValue("full_screen_width")) || cmrowAttribs.getValue("full_screen_width") == null) out.print("checked=\"checked\"");%> />
                &nbsp;&nbsp;&nbsp;&nbsp;
                Ναι <input style="float: none;" type="radio" name="CMRAttribs_full_screen_width" value="1" <%if ("1".equals(cmrowAttribs.getValue("full_screen_width"))) out.print("checked=\"checked\"");%> />
              </td>
            </tr>
            <tr>
                <td class="inputFrmLabelTD">head html code (css κλπ.)</td>
            ...
            <tr>
                <td class="inputFrmLabelTD">bottom html code (javascript κλπ.)</td>
            ...
            if (action.equals("EDIT")) { %>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="5" class="resultsTBL">
                <tr>
                    <td colspan="5" class="resultsHeader" align="center">Υποσελίδες - Modules</td>
                </tr>
                <%
                dbRet = sw_cmrow.getAdminRelatedCMRows(CMRCode,"CMCMRank DESC, CMCMCode ASC");
                ...
                if (rows > 0 && dbRet.getNoError() == 1) { %>
                    ...
                    for (int i=0; i<rows; i++) { %>
                      <form name="unrelateCMRowForm<%=i%>" method="post" action="<%=urlRelCMRow%>">
                      <input type="hidden" name="action1" value="">
                      <input type="hidden" name="databaseId" value="<%= databaseId %>">
                      ...
                      <tr class="resultsDataTR" onmouseover="this.className='resultsDataTROver'" onmouseout="this.className='resultsDataTR'">
                          ...
                          <td class="resultsDataTD" width="18%" onmouseover="this.className='resultsDataTDOver'" onmouseout="this.className='resultsDataTD'"><input type="text" name="CMCMRank" size="5" value="<%= sw_cmrow.getInt("CMCMRank") %>" class="inputFrmField" onfocus="this.className='inputFrmFieldFocus'" onblur="this.className='inputFrmField'" /></td>
                          <td class="resultsDataTD" width="18%" onmouseover="this.className='resultsDataTDOver'" onmouseout="this.className='resultsDataTD'">
                              <input type="button" name="changeCMRRelCMR" value="Μεταβολή" onclick ='document.unrelateCMRowForm<%=i%>.CMCMCode.value="<%= sw_cmrow.getColumn("CMCMCode") %>"; document.unrelateCMRowForm<%=i%>.action1.value="UPDATE"; document.unrelateCMRowForm<%=i%>.submit();' class="loginFrmBtn" onmouseover="this.className='loginFrmBtnOver'" onmouseout="this.className='loginFrmBtn'" />
                              <input type="button" name="unrelateCMRow" value="αποσυσχέτιση" onclick ='if (confirm("Είστε σίγουρος ότι θέλετε να αποσυσχετίσετε τη συγκεκριμένη εγγραφή;") == true) { document.unrelateCMRowForm<%=i%>.CMCMCode.value="<%=sw_cmrow.getColumn("CMCMCode")%>"; document.unrelateCMRowForm<%=i%>.action1.value="UNRELATE"; document.unrelateCMRowForm<%=i%>.submit(); } else return false;' class="loginFrmBtn" onmouseover="this.className='loginFrmBtnOver'" onmouseout="this.className='loginFrmBtn'" />
                          </td>
                ...
                <%
                    ...
                    <tr class="resultsDataTR">
                        <td class="resultsDataTD" colspan="5">Δεν έχετε πρόσβαση για συσχέτιση.</td>
                    </tr>
                <%
                }
                else if (rows == 0 && dbRet.getNoError() == 1) { %>
                    <tr class="resultsDataTR">
                        <td class="resultsDataTD" colspan="5">Δεν υπάρχουν συσχετίσεις.</td>
                    </tr>
                <%
                } %>
                <form name="buttonForm1">
                    <tr class="resultsFooterTR">
                        <td colspan="5"><input type="button" value="Συσχέτιση" onclick='location.href=("<%= response.encodeURL("relatecmrow.jsp?action1=CLOSE_SEARCH&CMCM_CMRCode1=" + CMRCode + "&CMRTitle=" + CMRTitle) %>")' class="loginFrmBtn" onmouseover="this.className='loginFrmBtnOver'" onmouseout="this.className='loginFrmBtn'" /></td>
                    </tr>
                </form>
                </table>
                <%-- } Related CMRows --%>
            ...
            <div class="tab_content" id="tab9">
              ...
              <input type="hidden" name="imageMaxWidth" value="1600" />
              <input type="hidden" name="imageMaxHeight" value="1200" />
              <input type="hidden" name="bgColor" value="#151515" />
