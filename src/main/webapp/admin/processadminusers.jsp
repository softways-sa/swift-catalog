...
<%@ page import="java.sql.Timestamp, gr.softways.dev.util.SwissKnife" %>
...
if (action.equals("EDIT")) {
    ...
    if (rows < 0) {
        ...
        dateLastUsed = processausr.getTimestamp("dateLastUsed");
    }
    processausr.closeResources(); 
}
else {
...
<body <%= bodyString %>>
    ...
    <tr>
        ...
        <td valign="top">
            ...
            <tr>
                <td class="inputFrmLabelTD">Λήξη λογαριασμού (ΗΗ/ΜΜ/ΕΕΕΕ)</td>
                <td class="inputFrmFieldTD"><input type="text" name="dateLastUsed" maxlength="15" value="<%if (dateLastUsed != null) out.print(SwissKnife.formatDate(dateLastUsed, "dd/MM/yyyy"));%>" class="inputFrmField" onfocus="this.className='inputFrmFieldFocus'" onblur="this.className='inputFrmField'" /></td>
            </tr>
