        ...
        <td valign="top">
            ...
            <tr>
                ...
                <%
                    ...
                    <td class="inputFrmFieldTD"><img src="/images/<%=catImgName1%>" alt="" width="200" height="150"/>&nbsp;&nbsp;<input type="file" name="img1" size="80" /> <input type="button" name="" value="Διαγραφή φωτογραφίας" onclick='if (confirm("Είστε σίγουρος για την διαγραφή;") == true) { document.inputForm.flag.value = "1"; document.inputForm.action1.value="DELETE_IMG"; document.inputForm.urlSuccess.value="<%= urlSuccess1 %>"; sendForm(); } else return false;'></td>
                <% } %>
            </tr>
            <tr class="inputFrmFooter">
                <td colspan="2" align="center"></br></br>
                    ...
                    <%
                        ...
                        <input type="button" value="Αποθήκευση" onClick='if (validateForm(document.inputForm)) { document.inputForm.action1.value="INSERT"; document.inputForm.urlSuccess.value="<%= urlSuccess %>"; sendForm();}' class="loginFrmBtn" onmouseover="this.className='loginFrmBtnOver'" onmouseout="this.className='loginFrmBtn'" />
