...
<%if (product_catalog_left_jsp_cmrow.getCMRow(LEFT_SIDEBAR_CMCCode,null).getRetInt() > 0) {%><div id="left-sidebar"><%=product_catalog_left_jsp_cmrow.getColumn("CMRText" + lang)%></div><%}%>
